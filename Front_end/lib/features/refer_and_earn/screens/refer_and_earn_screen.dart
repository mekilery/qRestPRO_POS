...
class _ReferAndEarnScreenState extends State<ReferAndEarnScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: ResponsiveHelper.isDesktop(context) || !_isLoggedIn
                          ...
                          child: Consumer<ProfileProvider>(
                            ...
                            return profileProvider.userInfoModel != null
                                ? ResponsiveHelper.isDesktop(context)
                                    ? ReferAndEarnWebWidget(hintList: hintList)
                                    : Column(children: [
                                        ///Header Section
                                        SizedBox(
                                              ...
                                              padding:
                                                  const EdgeInsets.symmetric(
                                                      horizontal: Dimensions
                                                          .paddingSizeDefault),
                                              child: Text(
                                                '${getTranslated('help_your_friends', context)!}\n${getTranslated('discover_qRestPRO', context)!}',
