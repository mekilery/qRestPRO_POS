  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(children: [
        ///Header Section
        const CustomAssetImageWidget(Images.referBanner,
            width: 150, height: 160, fit: BoxFit.contain),
        const SizedBox(height: Dimensions.paddingSizeLarge),

        Text(
          '${getTranslated('help_your_friends', context)!} ${getTranslated('discover_qRestPRO', context)!}',
          ...
          child: DottedBorder(
            ...
            child: Row(children: [
              ...
              IconButton(
                ...
                icon: CustomAssetImageWidget(Images.copySvg,
                    color: Theme.of(context).primaryColor),
              ),
            ]),
          ),
        ...
        Center(
          ...
          onTap: () => Share.share(profileProvider.userInfoModel!.referCode!,
              subject: profileProvider.userInfoModel!.referCode!),
          child: Container(
            margin: const EdgeInsets.symmetric(
