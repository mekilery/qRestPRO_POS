                    ...
                    <div class="modal-body pb-5 pt-0">
                        <div class="max-349 mx-auto mb-20">
                            ...
                            <div class="text-center">
                                ...
                                <a href="https://docs.qalaredia.com/docs-qRestPRO/admin-panel/mandatory-setup#firebase-configuration-for-notification" target="_blank" >{{translate('Click Here')}}</a>
                            </div>
                        </div>
                    </div>
                </div>
