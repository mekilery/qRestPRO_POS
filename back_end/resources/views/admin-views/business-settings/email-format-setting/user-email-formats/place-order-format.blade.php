                                                ...
                                                <div class="form-group mb-0">
                                                    <label class="form-label">
                                                        ...
                                                        <span class="input-label-secondary text--title" data-toggle="tooltip" data-placement="right"
                                                              data-original-title="{{ translate('Write_the_mail_body_message_within_75_words')}}">
                                                            <i class="tio-info-outined"></i>
                                                        </span>
                                                    </label>

                                                    <div id="editor-default" class="min-h-108px" data-id="mail-body">{!! $data?->body ?? '' !!}</div>
                                                    <textarea class="form-control quill-hidden" data-id="mail-body" id="ckeditor-default" name="body[]" style="display:none;"></textarea>
                                                </div>
                                                ...
                                                <div class="__bg-F8F9FC-card d-none lang_form" id="{{$lang->code}}-form">
                                                    ...
                                                    <div class="form-group mb-0">
                                                       <label class="form-label">
                                                        ...
                                                        <div id="editor-{{$lang_code}}" class="min-h-108px"> {!! $translate[$lang_code]['body']??'' !!}</div>
                                                        <textarea class="form-control" id="ckeditor-{{$lang_code}}" name="body[]" style="display:none;"></textarea>
                                                    </div>
                                                </div>
                                        ...
                                        @else
                                            <div class="__bg-F8F9FC-card default-form">
                                                ...
                                                <div class="form-group mb-0">
                                                    ...
                                                    <div id="editor-default" class="min-h-108px">Hi Sabrina,</div>
                                                    <textarea class="form-control" id="ckeditor-default" name="body[]" style="display:none;"></textarea>
                                                </div>
                                            </div>
                                            <input type="hidden" name="lang[]" value="default">
                                        @endif
