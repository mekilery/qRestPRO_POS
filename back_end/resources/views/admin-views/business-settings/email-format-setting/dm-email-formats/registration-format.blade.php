    ...
    <div class="content container-fluid">
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active">
                ...
                <form action="{{ route('admin.business-settings.email-setup.update', ['dm','registration']) }}" method="POST" enctype="multipart/form-data" id="order-form">
                    @csrf
                            ...
                            <div class="email-format-wrapper">
                                ...
                                <div class="right-content">
                                    ...
                                    <div>
                                        ...
                                        @if ($language)
                                            <div class="__bg-F8F9FC-card default-form lang_form" id="order-form">
