...
class UpdateController extends Controller
{
    ...
    public function update_software(Request $request)
    {
        ...
        Helpers::setEnvironmentValue('SOFTWARE_VERSION', '11.3');
        Helpers::setEnvironmentValue('APP_NAME', 'qRestPRO');
        ...
        try {
            if (!$data->getData()->active) {
                ...
                $activation_url = base64_decode('aHR0cHM6Ly9hY3RpdmF0aW9uLnFhbGFybWVkaWEuY29t');
