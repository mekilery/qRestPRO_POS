...
--
-- Host: localhost
-- Generation Time: Mar 12, 2023 at 08:32 AM
...
--
-- Database: `qRestPRO_installation`
--
...
CREATE TABLE `admins` (
  ...
  `identity_number` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL,
  `identity_type` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL,
...
(6, 'mail_config', '{\"status\":0,\"name\":\"Delivery APP\",\"host\":\"mail.demo.com\",\"driver\":\"smtp\",\"port\":\"587\",\"username\":\"info@demo.com\",\"email_id\":\"info@demo.com\",\"encryption\":\"tls\",\"password\":\"demo\"}', NULL, '2023-03-12 07:30:51'),
...
CREATE TABLE `products` (
  ...
  `product_type` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'veg, non_veg'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `table_orders` (
  ...
  `branch_table_token` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `branch_table_token_is_expired` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '1',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `users` (
  ...
  `login_medium` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
